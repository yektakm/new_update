...
public class TestPC {
    public static void main(String[] args) {
        ...
        Adder adder = new Adder("Program Counter", "64X33");
        for (int i =0; i < 32; ++i) {
...
//        }
        ...
        Multiplexer mux32X1 = new Multiplexer("mux" , "37X1");

        mux32X1.addInput(Simulator.trueLogic , Simulator.falseLogic , Simulator.falseLogic , Simulator.falseLogic , Simulator.falseLogic);
        for (int i=0 ; i<16 ; i++){
            mux32X1.addInput(Simulator.falseLogic);
        }

        mux32X1.addInput(Simulator.trueLogic);
        for (int i=0 ;i<15 ; i++ ){
            mux32X1.addInput(Simulator.falseLogic);
        }


        Simulator.debugger.addTrackItem( mux32X1 );
